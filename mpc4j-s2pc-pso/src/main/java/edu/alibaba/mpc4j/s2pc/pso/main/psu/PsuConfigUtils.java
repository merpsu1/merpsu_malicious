...
import edu.alibaba.mpc4j.s2pc.pso.psu.merpsu22.Merpsu22AhePsuConfig;
import edu.alibaba.mpc4j.s2pc.pso.psu.merpsu22.Merpsu22OtPsuConfig;
...
public class PsuConfigUtils {
    ...
    public static PsuConfig createPsuConfig(Properties properties) {
        ...
        switch (psuType) {
            ...
            case MERPSU22_AHE:
                return createMerpsu22AhePsuConfig(properties);
            case MERPSU22_OT:
                return createMerpsu22OtPsuConfig(properties);
            default:
                throw new IllegalArgumentException("Invalid " + PsuType.class.getSimpleName() + ": " + psuType.name());
        }
    }

    private static PsuConfig createMerpsu22OtPsuConfig(Properties properties) {
        return new Merpsu22OtPsuConfig.Builder()
                .setCoreCotConfig(CoreCotFactory.createDefaultConfig(SecurityModel.SEMI_HONEST))
                .setEccOvdmType(EccOvdmType.H3_SINGLETON_GCT)
                .build();
    }

    private static PsuConfig createMerpsu22AhePsuConfig(Properties properties) {
        return new Merpsu22AhePsuConfig.Builder()
                .setCoreCotConfig(CoreCotFactory.createDefaultConfig(SecurityModel.SEMI_HONEST))
