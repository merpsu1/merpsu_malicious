...
/**
 * MERPSU22-OT-PSU协议信息。论文来源：
 * Anonymous. More Efficient (Reusable) Private Set Union. eprint.
 *
 * @author Anonymous
 * @date 2022/10/28
 */
class Merpsu22OtPsuPtoDesc implements PtoDesc {
    /**
     ...
     * 协议名称
     */
    private static final String PTO_NAME = "MERPSU22_OT_PSU";
     ...
     * 单例模式
     */
    private static final Merpsu22OtPsuPtoDesc INSTANCE = new Merpsu22OtPsuPtoDesc();

    /**
     * 私有构造函数
     */
    private Merpsu22OtPsuPtoDesc() {
        // empty
    }
